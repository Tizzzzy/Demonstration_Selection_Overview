...
def run(logger, task, metaicl_data, metaicl_model, train_data, dev_data, seed,
    ...
    print("-----------------------------------demonstration selection end time---------------------------------")
    ...
    if os.path.exists(cache_path):
        ...
        if metaicl_model.is_none():
            print("checkpoint: ", checkpoint, "model: ", args.gpt2)
    ...
    print(f"demo time: {demo_end_time-demo_start_time} seconds, pure inference time: {inference_end_time-inference_time} seconds")
